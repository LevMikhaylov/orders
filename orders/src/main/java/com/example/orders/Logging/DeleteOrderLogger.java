...
@Aspect
@Component
public class DeleteOrderLogger {
    ...
    @Pointcut("execution (* com.example.orders.Controllers.OrderController.deleteOrder(..)) && args(id,..)")
    public void callOrderDelete() {}

    @Before("callOrderDelete()")
    ...
    @After("callOrderDelete()")
    public void saveLogToFile() throws Exception {
        String logMessage = "Order deleted successfully!\n";
