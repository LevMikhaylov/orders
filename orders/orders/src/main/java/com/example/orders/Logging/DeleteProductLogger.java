...
@Aspect
@Component
public class DeleteProductLogger {
    ...
    @Pointcut("execution (* com.example.orders.Controllers.ProductController.deleteProduct(..)) && args(id,..)")
    public void callProductDelete() {}

    @Before("callProductDelete()")
    ...
    @After("callProductDelete()")
    public void saveLogToFile() throws Exception {
        String logMessage = "Product deleted successfully!\n";
