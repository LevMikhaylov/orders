...
@Aspect
@Component
public class PostProductLogger {
    ...
    @Pointcut("execution (* com.example.orders.Controllers.ProductController.createProduct(..)) && args(product,..)")
    public void callProductAddition() {}

    @Before("callProuctAddition()")
    ...
    @After("callProductAddition()")
    public void saveLogToFile() throws Exception {
        String logMessage = "New product created successfully!\n";
