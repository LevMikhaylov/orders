...
@Aspect
@Component
public class DeleteCustomerLogger {
    ...
    @Pointcut("execution (* com.example.orders.Controllers.CustomerCOntroller.deleteCustomer(..)) && args(id,..)")
    public void callCustomerDelete() {}
    ...
    @After("callCustomerDelete()")
    public void saveLogToFile() throws Exception {
        String logMessage = "Customer deleted successfully!\n";
