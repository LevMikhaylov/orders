...
public class PostOrderLogger {
    ...
    @Pointcut("execution (* com.example.orders.Controllers.OrderController.createOrder(..)) && args(order,..)")
    public void callOrderAddition() {}

    @Before("callOrderAddition()")
    ...
    @After("callOrderAddition()")
    public void saveLogToFile() throws Exception {
        String logMessage = "New order created successfully!\n";
